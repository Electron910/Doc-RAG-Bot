...
- **Embedding Model & Vector DB**: ChromaDB is used as the persistent client because it runs locally with zero configuration and persists to disk. We use Google's `text-embedding-004` which is optimized for retrieval tasks.
...
- "What are the main causes mentioned in the document?"
- "Can you summarize section 2?"
- "Who were the key figures involved in this event?"
- "How does this technology work according to the text?"
